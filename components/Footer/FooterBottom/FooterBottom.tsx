    ...
    <>
      <div className="mt-16">
        <div className="col-span-2 flex gap-4 text-gray-500 lg:col-span-5">
          <Link href="https://www.facebook.com/dawid.kaczmarek.98/">
          ...
          <Link href="https://www.instagram.com/dave_2806pl/">
            <a className="hover:opacity-75" target="_blank" rel="noreferrer">
          ...
          <Link href="https://twitter.com/David28Pl">
            <a className="hover:opacity-75" target="_blank" rel="noreferrer">
          ...
          <Link href="https://github.com/Dawid2806">
            <a className="hover:opacity-75" target="_blank" rel="noreferrer">
